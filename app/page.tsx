          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-lg text-slate-600">
                Kami berkomitmen memberikan layanan terbaik untuk kesuksesan proyek Anda
              </p>
            </div>
            ...
            <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-lg bg-white p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Semua alat berat kami terawat dengan baik dan siap pakai untuk proyek Anda
                </p>
              </div>
              ...
              <div className="rounded-lg bg-white p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Dapatkan penawaran harga terbaik dengan fleksibilitas pembayaran
                </p>
              </div>
              ...
              <div className="rounded-lg bg-white p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Tim support kami siap membantu Anda kapan saja dibutuhkan
                </p>
              </div>
            </div>
          </div>

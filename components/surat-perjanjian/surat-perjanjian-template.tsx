      ...
      >
        ...
        <div className="mb-4 text-sm space-y-2">
          ...
          <div style={{ pageBreakInside: 'avoid' }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Jenis, Jumlah, Harga Sewa dan Lokasi Kerja.</p>
          ...
          <div style={{ pageBreakInside: "avoid" }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Tempat, Waktu dan Kondisi Penyerahan Alat Berat</p>
          ...
          <div style={{ pageBreakInside: 'avoid' }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Biaya Mobilisasi Alat Berat</p>
          ...
          <div style={{ pageBreakInside: "avoid" }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Biaya Operasi, Pemeliharaan dan Perbaikan Alat</p>
          ...
          <div style={{ pageBreakInside: "avoid" }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Operasi dan Operator</p>
          ...
          <div style={{ pageBreakInside: "avoid" }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Laporan Operasi Alat (Time Sheet)</p>
          ...
          <div style={{ pageBreakInside: "avoid" }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Pembayaran Sewa</p>
          ...
          <div style={{ pageBreakInside: "avoid" }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Keamanan Alat Berat</p>
          ...
          <div style={{ pageBreakInside: "avoid" }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Masa Perjanjian</p>
          ...
          <div style={{ pageBreakInside: "avoid" }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Pemindahan, Pengambilan dan Penggunaan Alat</p>
          ...
          <div style={{ pageBreakInside: "avoid" }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Perselisihan</p>
          ...
          <div style={{ pageBreakInside: "avoid" }}>
            ...
            <p className="font-bold mb-1" style={{ textAlign: "left" }}>Penutup</p>
